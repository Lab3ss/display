...
const URL = "https://www.journaldugeek.com/feed/";
const REDIS_KEY = "news.jdg";
const REDIS_TTL = 60 * 60 * 6;
...
const parser = async (flush = false) => {
  ...
  if (!json || !json.items || json.items.length <= 0) {
    throw new Error("Unable to get Jdg News RSS");
  }

  // Jdg does not provide some infos like picture url associated to the item.
